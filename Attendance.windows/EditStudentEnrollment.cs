...
{
    public partial class EditStudentEnrollment : Form
    {
        string errormessage = "";
        int count;
        ...
        private Student FillStudentData()
        {
            ...
            var std = new Student();
            std.StudentId = _db.Students.Where(s => s.MatricNo == txtMatricNo.Text).AsNoTracking().FirstOrDefault().StudentId;
        ...
        public bool CanSave()
        {
            ...
            if (picBoxFingerPrint.Visible && picBoxFingerPrint.Image == null)
            {
                cansave = false;
        ...
        {
            var student = _db.Students.Where(s => s.MatricNo == txtSrcMatricNo.Text).AsNoTracking().FirstOrDefault();
            if (student != null)
            {
                ...
                txtMiddleName.Invoke(new Action(() => { txtMiddleName.Text = student.MiddleName; }));
                txtMatricNo.Invoke(new Action(() => { txtMatricNo.Text = student.MatricNo; }));
                txtEmail.Invoke(new Action(() => { txtEmail.Text = student.Email; }));
                txtPhoneNo.Invoke(new Action(() => { txtPhoneNo.Text = student.Phone; }));
            ...
            {
                MessageBox.Show("The is no student with this matric number");
            }
        }
